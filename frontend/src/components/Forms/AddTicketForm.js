// components/Forms/AddTicketForm.js
...
const AddTicketForm = ({ onSubmit, onClose }) => {
  ...
  // Al montar, refrescamos el estado de Stripe
  useEffect(() => {
    if (user) {
  ...
  return (
    ...
    //     {/* Nombre del Ticket */}
    //     <InputWrapper>
    //       <Typography $variant="body-2-medium" as="label">
    ...
    //         placeholder="Introduce un nombre para la entrada..."
    //         required
    //       />
    ...
    //     <InputWrapper>
    //       <Typography $variant="body-2-medium" as="label">Cantidad:</Typography>
    //       <InputText
    //         type="number"
    //         name="capacity"
                  ...
                  <ConnectedAccountBanner>
                    ...
                    <StripeActions>
                      <Button size="medium" onClick={() => navigate('/user/' + (user._id || user.id) + '/settings')}>
                        Ir a Configuración
                        <img src="/icons/arrow-right-solid.svg" alt="new window icon" />
                      </Button>
                    </StripeActions>
                  </ConnectedAccountBanner>
